...
const quotes = [
  ...
  },
  {
    title: "خانواده محراب",
    passage:
      "برای رسیدن به آرمان بزرگ محراب، خانواده‌ای از جوان‌های متخصص را دور هم جمع کردیم. هرکس با این ویژگی‌ها می‌تواند عضوی از خانواده ما باشد:متعهد به اندیشه‌های ناب اسلامی و انقلابی باشد تا بتواند برای آرمان محراب تلاش کند.پر از شور یادگیری باشد تا بتواند به جدیدترین و به‌روزترین دانش‌های فنی و هنری مسلط شود.منظم و دقیق باشد تا بی‌وقفه و با جدیت در مسیر تولید آثار هنری قدم بردارد.",
  },
];
